...
(function () {
    ...
    class Menu {
        ...
        constructor(arr,cnt) {
            ...
            this.nav.classList.add("popup-menu__nav");
            this.cnt.appendChild(this.nav);
        };
        
        createMenu = function (menuElemArr,cnt,isSubmenu) {
            var ul = document.createElement("ul");
            ul.classList.add("popup-menu__list");
            if (isSubmenu) {
                ul.classList.add("popup-menu__list--hidden"); 
            }
            menuElemArr.forEach( function(el) {
                ...
                if (el.submenu) {
                    ...
                    debugger;
                    this.createMenu(el.submenu,li,true);
                }
                ul.appendChild(li);
            });
            cnt.appendChild(ul);
